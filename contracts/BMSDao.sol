...
contract BMSDao {
    //Holders of BMS Token can perticipate in the Dao 
    ...
    //In order to make proposals for the existing game elements open to DAO review, a single or pooled amount of 0.25% of BMS in circulation is necessary.  
    //All holders can vote on a 1:1 ratio of vote to BMS token. Passing is 2/3 of vote (YES?)
